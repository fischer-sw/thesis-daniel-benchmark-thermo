...
\begin{figure}[htb]
	\centering
	\includegraphics[scale=0.5]{DICHLOROMETHANE_CARBON DISULFIDE_isotherm_298.15_}
...
\begin{figure}[htb]
	\centering
	\includegraphics[scale=0.50]{ACETONE_N-PENTANE_isotherm_422.6_}
...
\begin{figure}[hbt]
	\centering
	\includegraphics[scale=0.50]{CHLOROFORM_ACETONE_isotherm_308.15_}
